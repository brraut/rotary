...
use App\Http\Requests\Contributor\AddFormValidation;
use App\Http\Requests\Contributor\EditFormValidation;
...
class ContributorController extends BaseController
{
    ...
    protected  $base_route = 'dashboard.contributor';
    protected  $view_path  = 'dashboard.contributor';
    protected  $panel      = 'Contributor Us';
    protected  $folder     = 'contributor';
    ...
    {
        $data=[];
        $data['contributor'] = $this->contributor->findById($id);
    ...
    public function update(EditFormValidation $request, $id)
    {
        ...
        $input =  parent::checkForDefaults($input);  
        if(isset($input['form_image'])){
            $file_name = $this->processImage($request->file('form_image'),$this->contributor->findById($id));
            $input['featured'] = $file_name;
         }   
        $this->contributor->renew($id,$input);   
