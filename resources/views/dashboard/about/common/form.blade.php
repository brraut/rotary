<div class="card-body">
      ...
      <div class="form-group">
        <label for="destinationName">Heading For About Section</label>
        ...
        <div class="col-sm-4">
          <div class="form-group pull-right">
            <label for="exampleInputFile">Current Banner</label><br>
              <img src="{{ asset('uploads/'.$_folder.'/'.$data['about']->featured) }}" alt="" class="img-responsive" height="100px" width="150px"
