<div class="card-body">
      ...
      <div class="form-group">
        <label for="destinationName">Cause Title</label>
        {!! Form::text('title',null,['class' => 'form-control','placeholder'=> 'Enter Heading']) !!}
        <small class="text-danger">{{ $errors->first('title') }}</small>
      </div>
      <div class="form-group">
        <label for="destinationName">Cause Subtitle</label>
        {!! Form::text('subtitle',null,['class' => 'form-control','placeholder'=> 'Enter Heading']) !!}
        <small class="text-danger">{{ $errors->first('subtitle') }}</small>
      </div>

      <div class="form-group">
        <label for="destinationDetails">Cause Description</label>
        ...
        <div class="col-sm-4">
          <div class="form-group pull-right">
            <label for="exampleInputFile">Current Banner</label><br>
              <img src="{{ asset('uploads/'.$_folder.'/'.$data['cause']->featured) }}" alt="" class="img-responsive" height="100px" width="150px"
