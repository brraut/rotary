    ...
    <div class="sub-banner">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('frontend.notice')}}">Notice</a></li>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="sidebar-section">
								<div class="sidebar-title">Other Notice</div>
								<ul>
                                @foreach ($data['other_news'] as $others)
									<li>
										<a href="{{ route('frontend.notice.single',$others->slug) }}">{{ $others->title }}</a>
                                    </li>
                                    @endforeach
